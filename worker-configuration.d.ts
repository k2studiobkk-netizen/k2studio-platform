/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b223166dec2157a0a614cda4aab94e90)
// Runtime types generated with workerd@1.20260515.1 2026-09-05 nodejs_compat
interface __BaseEnv_Env {
	...
	BROADCAST_HUB: DurableObjectNamespace<import("./worker/index").BroadcastHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "BroadcastHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAILS" | "ADMIN_HOSTNAME" | "CANONICAL_HOSTNAME" | "PUBLIC_SITE_URL">> {}
}
